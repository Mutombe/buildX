...
const PropertyTypeCard = ({ icon: Icon, title }) => (
  <Card variant="soft" sx={{ display: 'flex', alignItems: 'center', gap: 2, p: 2 }}>
    <Icon sx={{ fontSize: 32 }} />
    ...
    <CssVarsProvider>
      <Box sx={{ 
        ...
        <Box sx={{
          ...
          <Container maxWidth="lg">
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
              <Typography level="h4" component="h1" sx={{ color: 'white' }}>Homer</Typography>
              <ColorSchemePicker />
            </Box>
            
            <Grid container spacing={4} alignItems="center">
              <Grid xs={12} md={6}>
                <Typography level="h1" component="h2" mb={2} sx={{ 
                ...
                <Typography level="h4" component="h3" mb={4} sx={{ 
              ...
              <Grid xs={12} md={6}>
                <AspectRatio 
                  ...
                  sx={{ 
                    ...
                    overflow: 'hidden',
                    boxShadow: 'lg',
                    transform: 'perspective(1000px) rotateY(-15deg) rotateX(5deg) rotate(1deg) scale(0.9)',
                    transition: 'transform 0.3s ease-in-out',
                    '&:hover': {
                      transform: 'perspective(1000px) rotateY(-5deg) rotateX(5deg) rotate(1deg) scale(0.95)',
                    }
                  }}
                >
                  <img
        ...
        <Container maxWidth="lg">
          ...
          <Divider sx={{ my: 8 }}>
            <Chip variant="soft" color="primary">Diverse Property Types</Chip>
          </Divider>
          ...
          <Box sx={{ 
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <List>
                <ListItem>
                  <ListItemDecorator><CheckIcon color="primary" /></ListItemDecorator>
